...
function loc1()
    exports['qb-target']:AddBoxZone("loc1", vector3(-529.02, -201.53, 37.65), 0.6, 2.8, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes1",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
...
function loc2()
  exports['qb-target']:AddBoxZone("loc2", vector3(-527.45, -202.06, 37.65), 0.6, 2.4, {
    ...
    options = {
        {
          event = "FN-gardening:workbushes2",
          icon = 'fa fa-scissors',
          label = "Start Working",
        },
    },
...
function loc3()
  exports['qb-target']:AddBoxZone("loc3", vector3(-528.22, -205.03, 38.18), 4.0, 1, {
    ...
    options = {
        {
          event = "FN-gardening:workbushes3",
          icon = 'fa fa-scissors',
          label = "Start Working",
        },
    },
...
function loc4()
  exports['qb-target']:AddBoxZone("loc4", vector3(-522.46, -210.7, 37.65), 0.6, 3.0, {
    ...
    options = {
        {
          event = "FN-gardening:workbushes4",
          icon = 'fa fa-scissors',
          label = "Start Working",
        },
    },
...
function loc5()
    exports['qb-target']:AddBoxZone("loc5", vector3(-523.07, -212.23, 37.7), 0.6, 2.6, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes5",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
...
function loc6()
    exports['qb-target']:AddBoxZone("loc6", vector3(-525.27, -210.11, 37.7), 4.2, 0.8, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes6",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
...
function loc7()
    exports['qb-target']:AddBoxZone("loc7", vector3(-530.36, -213.53, 37.68), 3.2, 0.8, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes7",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
...
function loc8()
    exports['qb-target']:AddBoxZone("loc8", vector3(-530.2, -216.53, 37.6), 0.6, 2.2, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes8",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
...
function loc9()
    exports['qb-target']:AddBoxZone("loc9", vector3(-531.9, -215.97, 37.65), 2.4, 0.6, {
      ...
      options = {
          {
            event = "FN-gardening:workbushes9",
            icon = 'fa fa-scissors',
            label = "Start Working",
          },
      },
